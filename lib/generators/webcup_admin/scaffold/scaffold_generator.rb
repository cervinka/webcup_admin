...
module WebcupAdmin
  module Generators
    class ScaffoldGenerator < Rails::Generators::ModelGenerator
      ...
      class_option :bootstrap, type: :boolean, default: false, desc: 'Use bootstrap for templates', aliases: '-x'
      ...
      #   invoke controller, [ "#{prefix_name}/#{controller_name}", [] ]
      #   # invoke controller, [ "#{prefix_name}/#{controller_name}", options[:actions] ]
      # end
